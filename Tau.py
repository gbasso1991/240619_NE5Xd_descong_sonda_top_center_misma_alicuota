...
fig,ax= plt.subplots()
ax.plot(temperatura_1,tau_1_1,'.-',label='1')
ax.plot(temperatura_2,tau_1_2,'.-',label='2')
ax.plot(temperatura_3,tau_1_3,'.-',label='3')
...
plt.savefig('tau_vs_T'+identif_1+'.png',dpi=300)
